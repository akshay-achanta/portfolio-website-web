...
import { Heart, Target, Lightbulb, MapPin, Calendar, Award, Star, Zap } from 'lucide-react'
    ...
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mb-16 reveal">
          <div className="card-3d glass-depth rounded-2xl p-8 border border-purple-400/30 bg-gradient-to-r from-purple-500/5 to-cyan-500/5 relative overflow-hidden">
        ...
        {/* Story Cards */}
        <div className="perspective grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          {cards.map((card, i) => {
