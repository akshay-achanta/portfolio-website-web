  ...
  const certifications = [
    {
      ...
      issuer: "GAOTek Inc.",
      date: "2025",
      credentialId: "Awarded for outstanding leadership and delivery excellence",
      skills: ["Leadership", "Delivery Excellence", "Team Management", "Agile"],
      icon: Award,
    ...
    },
    {
      ...
      issuer: "Rush-A-Thon, Binary Club VIT Chennai",
      date: "2025",
      credentialId: "Managed 100+ participants",
      skills: ["Event Organization", "Technical Judging", "Community Building", "Public Speaking"],
      icon: Shield,
    ...
    },
    {
      ...
      issuer: "Forage",
      date: "2025",
      credentialId: "Simulated Job Experience",
      skills: ["AWS", "Cloud Computing", "Solution Architecture", "Infrastructure Design"],
      icon: Globe,
    ...
    },
    {
      ...
      date: "2024-2025",
      credentialId: "Course Completions",
      skills: ["Python for Data Science", "SQL for Analytics", "Machine Learning Fundamentals"],
      icon: TrendingUp,
